...
const url = "http://dotmat.altervista.org/meetbox/upload.php";
...
router.post("/create", async (req, res, next) => {
	...
	if (!name || isFolder === undefined || isNote === undefined || !workgroup)
		return res.status(412).json({
			error: "Error",
			message: "Il documento potrebbe avere non inserito correttamente uno dei parametri richiesti: name, isFolder, isNote",
		});
